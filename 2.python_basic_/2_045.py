...
proudtPrice = int(input('상품 가격 입력 : '))
payPrice = int(input('지불 금액 : '))

if  payPrice > proudtPrice:
    changeMoney = payPrice - proudtPrice
...
if changeMoney > money50000:
    ...
    changeMoney %= money50000  #복합연산자 사용 : changeMoney = changeMoney % money50000
